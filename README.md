# All Restaurants in Augusta-Richmond County (Metro), GA-SC, US
...
| Full dataset size | 1,426 records |
| Free sample size | 142 records (9.96%) |
| Last export | 2026-05-08T04:48:02.293900+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-augusta-richmond-county-metro-ga-sc-us-sample-659144/releases/download/sample-latest/beamstation_659144_restaurants-us-augustarichmondcountygasc_SAMPLE_DIST.csv) |
...
Search for dataset ID `659144` on BeamStation if you want the exact commercial listing.
